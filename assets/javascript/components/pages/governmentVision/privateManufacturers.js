...
export default class PrivateManufacturers extends React.Component {
    render () {
        return (
            <div>
                <h3 className='defaultHeader2'>Bio-Diesel sale by Private Manufacturers permitted</h3>
                <p>
                The government allowed private manufacturers of the environment friendly bio-diesel to sell directly to bulk consumers like the Indian Railways.
				“The union cabinet chaired by Prime Minister Narendra Modi, gave its approval for amending the Motor Spirit and High Speed Diesel control order for Regulation of Supply, Distribution and Prevention of Malpractices dated December 19, 2005,” a cabinet communique said here.
                </p>
                <br />
                <p>
				...
				The changes were made to address problems users faced in sourcing bio-diesel.
                </p>
                <br />
                <p>

            ...
            <div className="col-md-9 contentScreen">
               <div className="row">
               		<div className='col-md-12'>
               			...
               			<br />
               			<br />
               			<h3 className="defaultHeader">Algal Biodiesel</h3>
               			<p>
               			...
               			<br />
               			<p>
               				Prof. Rodrigo E. Teixeira from the University of Alabama in Huntsville demonstrated the extraction of biodiesel lipids from wet algae using a simple and economical reaction in ionic liquids.
               			</p>
               			<br />
               			<br />
               			<h3 className="defaultHeader">Pongamia</h3>
               			<p>
               			...
               			<br />
               			<br />
               			<h3 className="defaultHeader">Fungi</h3>
               			<p>
               			...
               			<br />
               			<br />
               			<h3 className="defaultHeader">Biodiesel from used coffee grounds</h3>
               			<p>
               			...
               			<br />
               			<br />
               			<h3 className="defaultHeader">Exotic sources</h3>
               			<p>
               			...
               			<br />
               			<p><b>Hydrogen fuel cells background information</b></p>
               			<p>

            ...
            <div className="col-md-9 contentScreen">
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <br />
                        <p>
                            Rapeseed is also known as Brassica Napus.
                        </p>
                        <br />    
                        <h3 className="defaultHeader">Scientific Classification</h3>
                        <dl className="dl-horizontal">
                            <dt>Kingdom:</dt> <dd>Plantae</dd>
                            <dt>Division:</dt> <dd>Magnoliophyta</dd>
                            <dt>Class:</dt> <dd>Magnoliopsida</dd>
                            <dt>Order:</dt> <dd>Capparales</dd>
                            <dt>Family:</dt> <dd>Brassicaceae</dd>
                            <dt>Genus:</dt> <dd>Brassica</dd>
                            <dt>Species:</dt> <dd>B. napus</dd>
                            <dt>Binomial name:</dt> <dd>Brassica napus L</dd>
                        </dl>
                        <br />
                        <p>
                        ...
                        <br />
                        <h3 className="defaultHeader">Cultivation and uses</h3>
                        <br />
                        <p>
                        ...
                        <br />
                        <h3 className="defaultHeader">Biodiesel</h3>
                        <p>
                        ...
                        <h3 className="defaultHeader">Biodiesel</h3>
                        <p>
                            Worldwide production of rapeseed (including canola) rose to 46.4 million metric tons in 2005, the highest recorded total.(source: FAQ)
                        </p>    
                        <br />
                        <p>
                            <b>Top Rapeseed Producers - 2005</b>
                        </p>
                        <table className="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Countries</th>
                                    <th>Million Metric Tonnes</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope='row'>World Total</th>
                                    <th>46.4</th>
                                </tr>
                            </tbody>
                        </table>
                        <p>
                            <b>Source:UN Food & Agriculture Organisation (FAO)</b>
                        </p>
                        <br /> 
                        <p>
                            <b>Top Rapeseed Producers - 2005</b>
